...
var errEmptyConfig = errors.New("Config cannot be empty in order to create a container")
...
func (daemon *Daemon) containerCreate(opts createOpts) (containertypes.ContainerCreateCreatedBody, error) {
	...
	if opts.params.Config == nil {
		return containertypes.ContainerCreateCreatedBody{}, errdefs.InvalidParameter(errEmptyConfig)
	}
	if opts.verifyImageSigned {
		...
		if err := daemon.verifyImageSigned(opts.params.Config.Image); err != nil {
